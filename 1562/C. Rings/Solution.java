...
//        solve(kattio);
    ...
    public static void solve(Kattio kattio) {
        ...
        if (index == -1) {
            sb.append(1).append(" ").append(n - 1).append(" ").append(2).append(" ").append(n);
        } else if (index < half) {
            sb.append(index + 1).append(" ").append(n).append(" ").append(index + 2).append(" ").append(n);
        } else {
            sb.append(1).append(" ").append(index + 1).append(" ").append(1).append(" ").append(index);
        }
        kattio.println(sb);
    }
